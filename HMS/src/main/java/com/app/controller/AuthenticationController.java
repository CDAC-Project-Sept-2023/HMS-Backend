...
//	}
	...
	@PostMapping("/testApi")
	//@PostMapping("/testApi/{name}/{email}/{password}")
	public String testApi(@RequestBody String request,@RequestHeader String name,@RequestHeader String email, @RequestHeader String password) {
		System.out.println("body"+request+"name=="+name+"email=="+email+"college"+password);
		return "successfull";
	}
